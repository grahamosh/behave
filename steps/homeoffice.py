...
def step_impl(context):
    context.wd = webdriver.Remote("http://localhost:4444/wd/hub", webdriver.DesiredCapabilities.FIREFOX.copy())
    pass
...
def step_impl(context):
   try:
           ...
           context.wd.get_screenshot_as_file('/Screenshots/screenshot.png')
